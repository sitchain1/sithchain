...
COIN_TGZ="https://github.com/sithchain-official/sithchain/releases/download/v1.0.0.1/sithchaincore-1.0.0-linux${KERN_ARCH}.tar.gz"
...
function install_sentinel() {
  ...
  local SENTINEL_PATH="sentinel-sithchain"
  cd $CONFIGHOME
  git clone https://github.com/sithchain-official/sentinel.git $SENTINEL_PATH
  cd $SENTINEL_PATH
