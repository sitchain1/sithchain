...
Sithchain Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 7425.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 7424 for connections and services them.
...
However, in open source software such as Sithchain Core, where everyone uses
...
pay attention to for reviewers of Sithchain Core code.

General Sithchain Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Sithchain Core uses tinyformat, which is type safe. Leave them out to avoid confusion
