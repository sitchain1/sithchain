...
This mechanism has been integrated into Bitcore-Node-Sithchain which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/sithchain-official/insight-api-sithchain#web-socket-api](https://github.com/sithchain-official/insight-api-sithchain#web-socket-api)
* API: [https://github.com/sithchain-official/insight-api-sithchain#instantsend-transactions](https://github.com/sithchain-official/insight-api-sithchain#instantsend-transactions)
...
By default, the Sithchain Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Sithchain Core daemon:
