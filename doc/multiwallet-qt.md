...
Only requiring some minor changes is sithchain.cpp.
...
Changes to sithchain.cpp
----------------------
sithchain.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
