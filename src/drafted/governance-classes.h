 ...
 *
 *   // network
 *   CSithchainNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.sithchain.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSithchainNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CSithchainNetwork(UniValue objIn)
    {
...
// // can be under: SithchainNetwork
// //   -- signature requirements : Key1(User)
// class CSithchainNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == SithchainNetwork);
//     // }
