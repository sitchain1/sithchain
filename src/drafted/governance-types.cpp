...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SithchainNetwork") type = SithchainNetwork;
    if(strType == "SithchainNetworkVariable") type = SithchainNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SithchainNetwork) s = "SithchainNetwork";
    if(type == SithchainNetworkVariable) s = "SithchainNetworkVariable";
