    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Sithchain Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Sithchain address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sithchain: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Sithchain Core"), this);
    aboutAction->setStatusTip(tr("Show information about Sithchain Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Sithchain Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Sithchain addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Sithchain addresses"));
    ...
    openAction->setStatusTip(tr("Open a sithchain: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Sithchain Core help message to get a list with possible Sithchain Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Sithchain Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Sithchain network", "", count));
    } else {
...
{
    QString strTitle = tr("Sithchain Core"); // default title
    ...
    // Append title to "Sithchain Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
