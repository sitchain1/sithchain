    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SITHASH-light"), QVariant("light"));
    ui->theme->addItem(QString("SITHASH-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("SITHASH-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SITHASH-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SITHASH-traditional"), QVariant("trad"));
