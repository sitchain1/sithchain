    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Sithchain Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Sithchain Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  sithchain-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Sithchain in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SITH, 0.1 SITH, 1 SITH and 10 SITH -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://sithchain.com\">https://sithchain.com</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Sithchain Core is shutting down...") + "<br /><br />" +
