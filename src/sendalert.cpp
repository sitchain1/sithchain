...
2. run sithchaind with -printalert or -sendalert like this:
   /path/to/sithchaind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.sithchain.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Sithchain Core:0.12.0.58/"));
