...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Sithchain Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  sithchain-cli [options] <command> [params]  " + _("Send command to Sithchain Core") + "\n" +
                  "  sithchain-cli [options] help                " + _("List commands") + "\n" +
                  "  sithchain-cli [options] help <command>      " + _("Get help for a command") + "\n";
