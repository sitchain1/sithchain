...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Sithchain Core sithchain-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  sithchain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sithchain transaction") + "\n" +
              "  sithchain-tx [options] -create [commands]   " + _("Create hex-encoded sithchain transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded sithchain transaction
