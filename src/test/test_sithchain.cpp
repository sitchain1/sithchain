...
#define BOOST_TEST_MODULE Sithchain Test Suite

#include "test_sithchain.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_sithchain_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
